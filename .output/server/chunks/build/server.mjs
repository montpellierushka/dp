import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, defineComponent, computed, unref, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { k as createHooks, l as getContext, h as createError$1, m as toRouteMatcher, n as createRouter, o as defu, p as hasProtocol, q as joinURL, w as withQuery, r as sanitizeStatusCode, v as isScriptProtocol, x as executeAsync, y as defuFn, z as klona } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "travel",
    path: "/travel",
    component: () => import('./travel.vue.mjs')
  },
  {
    name: "favorites",
    path: "/favorites",
...
const plugin_IqSFGHiWkXfcd1GUWq1qC60QEvYtIIxjVafbxmje9Ys = defineNuxtPlugin({
  name: "nuxt-icon",
  setup() {
    var _a, _b;
...
export { _export_sfc as _, useRouter as a, useRoute as b, useAppConfig as c, useNuxtApp as d, useRuntimeConfig as e, asyncDataDefaults as f, createError as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
